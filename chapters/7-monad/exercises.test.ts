...
test("Ch7 Q1", () => {
  ...
  expect(ch7_q1(new Set([1, 2, 3, 4]))).toStrictEqual(
    new Set([1, 2, 3, 4, 6, 8])
  );
  expect(ch7_q1(new Set([1, 2, 3, 4, 5]))).toStrictEqual(
    new Set([1, 2, 3, 4, 5, 6, 8, 10])
  );
...
test("Ch7 Q2", () => {
  ...
  expect(ch7_q2(new Set([1, 2, 3]))).toStrictEqual(
    new Set([1, 2, 3, 4, 6, 8, 12])
  );
  expect(ch7_q2(new Set([1, 2, 3, 4]))).toStrictEqual(
    new Set([1, 2, 3, 4, 6, 8, 12, 16])
  );
